...
df_3df = pd.DataFrame({'name': np.concatenate((bootes_df.name, np.concatenate( (elais_df.name,lh_df.name ), axis=None)), axis=None),\
                       'ngalaxies': np.concatenate( (bootes_df.ngalaxies,np.concatenate( (elais_df.ngalaxies,lh_df.ngalaxies ), axis=None)), axis=None),\
